    ...
    return (
      <div className="aside">
        ...
        <div className="tag-list">
          ...
          <div className="tab-box">
            2020年毕业，软件工程专业，专业从事前端工作2年。曾经担任过两家软件公司前端，第一家公司为创业型公司，负责公司主要项目的研发工作，使用uniapp多端开发软件应用。附带一些额外的如后台管理系统以及公司网站建设，主要技术栈为uniapp。第二家公司担任公司tv视频播放项目的前端研发，使用的是h5+原生app混合开发,使用vue全家桶，附带一些小程序以及支付和视频播放相关工作,从项目成立到上线,再到日活几万,到后面独立承担此项目的前端开发与维护
          </div>
        </div>
        <div className="tag-list">
